...
class bgThread(Thread):
    daemon: bool
    name: str
    def __init__(self, name: str | None = ..., **kwargs: Incomplete) -> None: ...
    def body(self) -> None: ...
    def on_crash(self, msg: Incomplete, *fmt: Incomplete, **kwargs: Incomplete) -> None: ...
    def run(self) -> None: ...
    def stop(self) -> None: ...
...
class Local:
    ...
    def __call__(self, proxy: Incomplete) -> Incomplete: ...
...
class LocalManager:
    ...
    def __init__(
        self, locals: Incomplete | None = ..., ident_func: Incomplete | None = ...
    ) -> None: ...
