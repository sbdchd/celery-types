...
class Blueprint:
    ...
    def stop(
        self, parent: Incomplete, close: bool = ..., terminate: bool = ...
    ) -> None: ...
...
class StepType(type):
    ...
    def __new__(
        cls, name: Incomplete, bases: Incomplete, attrs: Incomplete
    ) -> Incomplete: ...
...
class Step(metaclass=StepType):
    ...
    def instantiate(
        self, name: Incomplete, *args: Incomplete, **kwargs: Incomplete
    ) -> Incomplete: ...
