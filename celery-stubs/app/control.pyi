...
class Inspect:
    ...
    def report(self) -> None | list[dict[str, Any]]: ...
    def clock(self) -> None | list[dict[str, Any]]: ...
    def active(self, safe: Any | None = ...) -> None | list[dict[str, _Reply]]: ...
    def scheduled(self, safe: Any | None = ...) -> None | list[dict[str, Any]]: ...
    def reserved(self, safe: Any | None = ...) -> None | list[dict[str, Any]]: ...
    def stats(self) -> None | dict[str, _Reply]: ...
    def revoked(self) -> None | list[dict[str, _Reply]]: ...
    def registered(self, *taskinfoitems: Any) -> None | list[dict[str, _Reply]]: ...
    registered_tasks = registered
    def ping(
        self, destination: _Destination | None = ...
    ) -> None | list[dict[str, _Reply]]: ...
    def active_queues(self) -> None | list[dict[str, _Reply]]: ...
    def query_task(self, *ids: str) -> None | list[dict[str, _Reply]]: ...
    def conf(self, with_defaults: bool = ...) -> None | list[dict[str, _Reply]]: ...
    def hello(
        self, from_node: Any, revoked: Any | None = ...
    ) -> None | list[dict[str, _Reply]]: ...
    def memsample(self) -> None | list[dict[str, _Reply]]: ...
    def memdump(self, samples: int = ...) -> None | list[dict[str, _Reply]]: ...
    def objgraph(
