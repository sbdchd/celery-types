...
class Resource:
    ...
    def __init__(self, limit: int | None = ..., preload: int | None = ..., close_after_fork: bool | None = ...) -> None: ...
    def setup(self) -> None: ...
    ...
    def resize(self, limit: int, force: bool = ..., ignore_errors: bool = ..., reset: bool = ...) -> None: ...
...
class Connection:
    ...
    def autoretry(
        self, fun: Callable[..., _T], channel: StdChannel | None = ..., **ensure_options: Any
    ) -> _T: ...
    def ensure(
        self,
        obj: Any,
    ...
    def Producer(self, channel: StdChannel | None = ..., *args: Any, **kwargs: Any) -> Producer: ...
    def Consumer(
        self,
        queues: Any | None = ...,
...
class ConnectionPool(Resource):
    ...
    def __init__(self, connection: Connection, limit: int | None = ..., **kwargs: Any) -> None: ...
    ...
    def collect_resource(self, resource: Connection, socket_timeout: float | None = ...) -> None: ...
    def acquire_channel(self, block: bool = ...) -> Generator[StdChannel, None, None]: ...
