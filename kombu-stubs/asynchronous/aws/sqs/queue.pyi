...
class AsyncQueue:
    ...
    def __init__(
        self, connection: Any = ..., url: str | None = ...,
        message_class: type[AsyncMessage] = ...
    ) -> None: ...
    ...
    def get_attributes(
        self, attributes: str = ..., callback: Any = ...
    ) -> promise: ...
    def set_attribute(
    ...
    def set_timeout(
        self, visibility_timeout: int, callback: Any = ...
    ) -> promise: ...
    def _on_timeout_set(self, visibility_timeout: int | None) -> int | None: ...
    def add_permission(
        self, label: str, aws_account_id: str, action_name: str,
        callback: Any = ...
    ) -> promise: ...
    def remove_permission(
        self, label: str, callback: Any = ...
    ) -> promise: ...
    def read(
        self, visibility_timeout: int | None = ...,
        wait_time_seconds: int | None = ..., callback: Any = ...
    ) -> promise: ...
    def write(
        self, message: Any, delay_seconds: int | None = ...,
        callback: Any = ...
    ) -> promise: ...
    def write_batch(
    ...
    def get_messages(
        self, num_messages: int = ..., visibility_timeout: int | None = ...,
        attributes: Any = ..., wait_time_seconds: int | None = ...,
        callback: Any = ...
    ) -> promise: ...
    def delete_message(
        self, message: Any, callback: Any = ...
    ) -> promise: ...
