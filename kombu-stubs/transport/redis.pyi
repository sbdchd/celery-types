...
@contextmanager
def Mutex(
    client: Any, name: str, expire: int
...
class PrefixedStrictRedis(GlobalKeyPrefixMixin, redis_module.Redis):  # type: ignore[type-arg]
    global_keyprefix: str

    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def pubsub(self, **kwargs: Any) -> PrefixedRedisPubSub: ...

class PrefixedRedisPipeline(GlobalKeyPrefixMixin, redis_module.client.Pipeline):  # type: ignore[type-arg]
    global_keyprefix: str
