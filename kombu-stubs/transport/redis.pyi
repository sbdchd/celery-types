...
class PrefixedStrictRedis(GlobalKeyPrefixMixin, redis_module.Redis[Any]):
    global_keyprefix: str

    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def pubsub(self, **kwargs: Any) -> PrefixedRedisPubSub: ...

class PrefixedRedisPipeline(GlobalKeyPrefixMixin, redis_module.client.Pipeline[Any]):
    global_keyprefix: str
