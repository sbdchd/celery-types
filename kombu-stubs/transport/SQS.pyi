...
class QoS(VirtualQoS):
    ...
    def apply_backoff_policy(
        self, routing_key: str, delivery_tag: int,
        backoff_policy: dict[int, int], backoff_tasks: list[str]
    ) -> None: ...
...
class Channel(VirtualChannel):
    ...
    def close(self) -> None: ...
    def new_sqs_client(
        self, region: str, access_key_id: str,
        secret_access_key: str, session_token: str | None = ...
    ) -> Any: ...
